@extends('layouts.main', ['activePage'=>'negocios', 'titlePage'=>'Editar Negocio']);
@section('content')
    <div class="content">
                    ...
                    <form action="{{ route('negocios.update', $negocio->id) }}" method="post" class="form-horizontal">
                        ...
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <p>Actualice los datos del Negocio</p>
                            </div>
                            <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input type="text" name="name" class="form-control" placeholder="{{ __('Ingrese nombre del negocio') }}" value="{{ $negocio->name }}" autofocus>
                                            @if ($errors->has('name'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                            <textarea rows="3" type="text" name="description" class="form-control" placeholder="{{ __('Ingrese descripción del negocio') }}" value="{{ old('description') }}" autofocus>{{ $negocio->description }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('nit') ? ' has-danger' : '' }}">
                                            <input type="text" name="nit" class="form-control" placeholder="{{ __('Ingrese NIT del negocio') }}" value="{{ $negocio->nit }}" autofocus>
                                            @if ($errors->has('nit'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <input type="email" name="email" class="form-control" placeholder="{{ __('Ingrese correo del negocio') }}" value="{{ $negocio->email }}" autofocus>
                                            @if ($errors->has('email'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                            <input type="text" name="phone" class="form-control" placeholder="{{ __('Ingrese telefono del negocio') }}" value="{{ $negocio->phone }}" autofocus>
                                            @if ($errors->has('phone'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('cellphone') ? ' has-danger' : '' }}">
                                            <input type="text" name="cellphone" class="form-control" placeholder="{{ __('Ingrese celular del negocio') }}" value="{{ $negocio->cellphone }}" autofocus>
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                ...
                                <a href="{{ route('negocios.index') }}" class="btn btn-danger">Cancelar</a>
                            </div>
                        </div>
                    </form>
